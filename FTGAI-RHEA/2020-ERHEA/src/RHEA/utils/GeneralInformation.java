...
public class GeneralInformation {
	...
	public void recordPair(FrameData cur_frame, FrameData nx_frame, Action sel_act) {
		...
		// record infos
		this.dlOpModel.record(this.gamedata, cur_frame, nx_frame, this.selfPlayer, sel_act.ordinal(),
				opp_sel_act.ordinal());

	}

	public void updateInfos(FrameData frameData, LinkedList<Action> startAvailActions, LinkedList<Action> myStart,
			LinkedList<Action> oppStart) {
		...
		// // CharacterData my_cd =
		// this.recordLastFrameData.getCharacter(this.selfPlayer);
		// // CharacterData opp_cd =
		// this.recordLastFrameData.getCharacter(!this.selfPlayer);
		// // System.out.println("cur my_hp:"+my_cd.getHp() + " opp_hp:" +
		// opp_cd.getHp());

		// this.dlOpModel.record(this.gamedata, this.recordLastFrameData,
		// this.frameData, this.selfPlayer, lastOppAct.ordinal());
		// // System.out.println("record act:" + oppAct);
	...
	public boolean IsGameOver() {
		if (this.frameData.getCharacter(this.selfPlayer).getHp() == 0
				|| this.frameData.getCharacter(!this.selfPlayer).getHp() == 0)
			return true;
		return false;
	...
	public DLOpponentModel getDLopModel() {
		return this.dlOpModel;
	}
